...
import scrapy
from crawler.items import ParkingRentItem, ParkingRentDetailItem, ParkingRentImageItem
import sys
import time
import urlparse
import os
    ...
    def parse_detail(self, response):    
        ...
        for sel in response.xpath('//div[@class="module1 left"]'):
            try:
                ...
                image_item = ParkingRentImageItem()
