...
RAW_DB = settings['MONGODB_DB_PARKING_RAW']
CONNECTION = pymongo.MongoClient(SERVER, PORT)
RAW_DB = CONNECTION[RAW_DB] 
DB = CONNECTION[DB]  
RAW_COLLECTION = RAW_DB[PARAMS['crawl_date']]
...
COLLECTION = DB[settings['MONGODB_COLLECTION_ALL_PARKINGS']]
COLLECTION_NEW_ADD = DB[settings['MONGODB_COLLECTION_NEW_ADD_PARKING']]
COLLECTION_RESIDENCE_NUM_BY_DAY = DB[settings['MONGODB_COLLECTION_PARKING_NUM_BY_DAY']]
