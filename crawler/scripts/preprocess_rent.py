...
RAW_DB = settings['MONGODB_DB_RENT_RAW']
CONNECTION = pymongo.MongoClient(SERVER, PORT)
RAW_DB = CONNECTION[RAW_DB] 
DB = CONNECTION[DB]  
RAW_COLLECTION = RAW_DB[PARAMS['crawl_date']]
...
COLLECTION = DB[settings['MONGODB_COLLECTION_ALL_RENT_RESIDENCES']]
COLLECTION_NEW_ADD = DB[settings['MONGODB_COLLECTION_NEW_ADD_RENT']]
COLLECTION_RESIDENCE_NUM_BY_DAY = DB[settings['MONGODB_COLLECTION_RENT_RESIDENCE_NUM_BY_DAY']]
